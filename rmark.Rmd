...
```{r histogramme, echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/Histogramme_de_collaboration_par_cours.png", error = FALSE)
```
...
![Histogramme1](projet_bio_500/Rplot.png)
#Figure 1 

![Histogramme1](figures/Histogramme_de_collaboration_entre_etudiants.png)

#Figure 2
![Histogramme1](figures/Histogramme_de_collaboration_par_cours.png)
